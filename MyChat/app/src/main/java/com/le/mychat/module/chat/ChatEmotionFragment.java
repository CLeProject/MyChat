...
import com.le.mychat.module.chat.adapter.EmotionGridViewAdapter;
import com.le.mychat.module.chat.adapter.EmotionPagerAdapter;
import com.le.mychat.module.chat.util.EmotionUtils;
import com.le.mychat.module.chat.util.GlobalOnItemClickManagerUtils;
import com.le.mychat.module.chat.util.Utils;
import com.le.mychat.module.chat.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    @ViewInject(R.id.fragment_chat_vp)
    ViewPager fragmentChatVp;
    @ViewInject(R.id.fragment_chat_group)
